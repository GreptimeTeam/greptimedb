...
mod test {
    ...
    async fn test_otlp(instance: &Arc<Instance>) {
        ...
        assert_eq!(
            ...
            "\
+----------------+---------------------+----------------+-----------------+-----------------------+------------------+-------------------------------+--------------------+
| container_name | greptime_timestamp  | greptime_value | otel_scope_name | otel_scope_schema_url | otel_scope_scope | otel_scope_telemetry_sdk_name | otel_scope_version |
+----------------+---------------------+----------------+-----------------+-----------------------+------------------+-------------------------------+--------------------+
| testsevrer     | 1970-01-01T00:00:00 | 100.0          |                 |                       | otel             | java                          |                    |
| testserver     | 1970-01-01T00:00:00 | 105.0          |                 |                       | otel             | java                          |                    |
+----------------+---------------------+----------------+-----------------+-----------------------+------------------+-------------------------------+--------------------+",
        );
...
+-----+----------------+",
        ...
        assert_eq!(
            ...
            "\
+---------------------+----------------+------------+-----------------+-----------------------+------------------+-------------------------------+--------------------+
| greptime_timestamp  | greptime_value | host       | otel_scope_name | otel_scope_schema_url | otel_scope_scope | otel_scope_telemetry_sdk_name | otel_scope_version |
+---------------------+----------------+------------+-----------------+-----------------------+------------------+-------------------------------+--------------------+
| 1970-01-01T00:00:00 | 51.0           | testserver |                 |                       | otel             | java                          |                    |
+---------------------+----------------+------------+-----------------+-----------------------+------------------+-------------------------------+--------------------+",
        );
...
| greptime_timestamp  | greptime_value | host       | otel_scope_name | otel_scope_schema_url | otel_scope_scope | otel_scope_telemetry_sdk_name | otel_scope_version |
+---------------------+----------------+------------+-----------------+-----------------------+------------------+-------------------------------+--------------------+
| 1970-01-01T00:00:00 | 4.0            | testserver |                 |                       | otel             | java                          |                    |
+---------------------+----------------+------------+-----------------+-----------------------+------------------+-------------------------------+--------------------+",
        );
    }
