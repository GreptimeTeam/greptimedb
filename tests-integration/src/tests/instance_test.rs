...
| greptime      | information_schema | tables     | check_time               | timestamp(3)    | FIELD         |
...
| greptime      | information_schema | tables     | create_time              | timestamp(3)    | FIELD         |
...
| greptime      | information_schema | tables     | update_time              | timestamp(3)    | FIELD         |
...
| another_catalog | information_schema | tables        | check_time               | timestamp(3)    | FIELD         |
...
| another_catalog | information_schema | tables        | create_time              | timestamp(3)    | FIELD         |
...
| another_catalog | information_schema | tables        | update_time              | timestamp(3)    | FIELD         |
