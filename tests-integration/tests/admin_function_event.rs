...
async fn assert_admin_function_events(instance: &Arc<Instance>) {
    ...
    assert_admin_event(
        ...
        "\
+----------------+---------------------+-----------+---------------------------------------------------------+--------------+
| type           | admin_function_name | status    | input                                                   | output       |
+----------------+---------------------+-----------+---------------------------------------------------------+--------------+
| admin_function | flush_table         | Succeeded | {\"arguments\":[\"admin_function_event_test\"],\"version\":1} | {\"result\":0} |
+----------------+---------------------+-----------+---------------------------------------------------------+--------------+",
    )
    .await;
...
| type           | admin_function_name    | status | input                                       | output                                                          |
+----------------+------------------------+--------+---------------------------------------------+-----------------------------------------------------------------+
| admin_function | missing_admin_function | Failed | {\"arguments\":[\"missing-input\"],\"version\":1} | {\"error\":\"0: Admin function not found: missing_admin_function\"} |
+----------------+------------------------+--------+---------------------------------------------+-----------------------------------------------------------------+",
    )
    .await;
}
