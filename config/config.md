...
| `query.enable_promql_series_aggregate` | Bool | `true` | Whether PromQL range queries of the form `aggr(range_fn(...))` use the series-aware<br/>aggregate operators. When false, these queries use the generic hash aggregate plan. |
