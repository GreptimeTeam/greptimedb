...
| `default_column_prefix` | String | Unset | The default column prefix for auto-created time index, value, and native histogram columns,<br/>and the reserved raw-delta temporality label (`__<prefix>_temporality__`).<br/>Legacy OTLP summary columns keep their historical `greptime_` prefix. |
