...
| `region_engine.mito.experimental_series_index_root` | String | `""` | Root below `data_home` for loading range and series indexes stored locally.<br/>An empty value disables series-index loading and cleanup.<br/>Under development; do not enable this feature. |
