...
The default remote-write coverage set contains six cases with the same 2048
...
- `prom_remote_write_linear_fractional`: continuous fractional linear values
  with a base of 0 and step of 0.125.
- `prom_remote_write_constant`: constant 42.0 values for an extreme
  dictionary-friendly, low-cardinality shape.
