...
only this case; `/query-regression` runs the eight routine default cases, including
`sst_float_bss` and `promql_instant_last_row_9034`. Manual
...
default cases, including `sst_float_bss` and `promql_instant_last_row_9034`;
