...
delete from test_table where cpu = 66.6 and ts = 1655276557000;

delete from test_table where host = 'host1' or ts = 1655276557000;

delete from test_table where host = 'host1' or ts != 1655276557000;

delete from test_table where  ts != 1655276557000;
