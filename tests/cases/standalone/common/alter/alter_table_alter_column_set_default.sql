...
ALTER TABLE test1 MODIFY COLUMN l SET DEFAULT 201;
ALTER TABLE test1 MODIFY COLUMN m SET DEFAULT '2024-01-30 00:00:00';
ALTER TABLE test1 MODIFY COLUMN n SET DEFAULT 300;
