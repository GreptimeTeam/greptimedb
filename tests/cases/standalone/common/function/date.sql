...
SELECT date_add('2023-12-06 07:39:46.222726'::TIMESTAMP_MS, '5 day');

SELECT date_add('2023-12-06'::DATE, INTERVAL '3 month 5 day');

SELECT date_add('2023-12-06'::DATE, '3 month 5 day');

SELECT date_sub('2023-12-06 07:39:46.222726'::TIMESTAMP_MS, INTERVAL '5 day');

SELECT date_sub('2023-12-06 07:39:46.222726'::TIMESTAMP_MS, '5 day');
