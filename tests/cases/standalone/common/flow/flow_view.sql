...
SELECT created_time = updated_time, created_time IS NOT NULL FROM information_schema.flows WHERE flow_name = 'user_agent_flow';
...
SELECT created_time < updated_time, created_time IS NOT NULL, updated_time IS NOT NULL FROM information_schema.flows WHERE flow_name = 'user_agent_flow';
