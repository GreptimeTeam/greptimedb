...
pub struct GreptimeVersionReport {
    statistic: Arc<dyn Reporter + Send + Sync>,
...
impl GreptimeVersionReport {
    pub fn new(statistic: Arc<dyn Reporter + Send + Sync>) -> Self {
...
mod tests {
    ...
    use crate::version_reporter::{GreptimeVersionReport, ReportData, Reporter};
