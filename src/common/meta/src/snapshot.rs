...
mod tests {
    ...
    async fn test_dump_and_restore() {
        ...
        let (_temp_dir, kv_backend, manager) = test_env("test_dump_and_restore");
        ...
        kv_backend.clear();
        let err = manager
            .dump("snapshot/metadata_snapshot.metadata.fb")
            .await
            .unwrap_err();
        ...
        manager
            .restore("snapshot/metadata_snapshot.metadata.fb")
            .await
            .unwrap();
