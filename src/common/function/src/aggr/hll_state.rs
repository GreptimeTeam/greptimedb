...
impl HllState {
    ...
    /// Create a UDF for the `hll_state` function.
    ///
    /// `hll_state` accepts a string column and aggregates the
    ...
    ///
    /// `hll_merge` accepts a binary column of states generated by `hll_state`
