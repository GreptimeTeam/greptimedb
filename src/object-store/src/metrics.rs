...
lazy_static! {
    ...
    pub static ref OBJECT_STORE_LRU_CACHE_HIT: IntCounterVec = register_int_counter_vec!(
        "greptimedb_object_store_lru_cache_hit",
    ...
    pub static ref OBJECT_STORE_LRU_CACHE_MISS: IntCounter =
        register_int_counter!("greptimedb_object_store_lru_cache_miss", "object store lru cache miss")
            .unwrap();
    /// Object store read error counter
    pub static ref OBJECT_STORE_READ_ERROR: IntCounterVec = register_int_counter_vec!(
        "greptimedb_object_store_read_errors",
    ...
    pub static ref OBJECT_STORE_LRU_CACHE_ENTRIES: IntGauge =
        register_int_gauge!("greptimedb_object_store_lru_cache_entries", "object store lru cache entries")
            .unwrap();

    /// Cache size in bytes
    pub static ref OBJECT_STORE_LRU_CACHE_BYTES: IntGauge =
        register_int_gauge!("greptimedb_object_store_lru_cache_bytes",  "object store lru cache bytes")
            .unwrap();
}
