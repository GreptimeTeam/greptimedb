...
/// A v1 chunk request plus the metadata needed for span-level fallback.
...
/// Sparse retry representation of a failed v1 trace chunk.
...
/// An atomic column rewrite prepared for one trace chunk.
