...
pub type ClientManagerRef = Arc<ClientManager>;
...
impl Client {
    ...
    pub fn new(raw_client: Arc<PartitionClient>, config: &KafkaConfig) -> Self {
...
impl ClientManager {
    ...
    pub async fn get_or_insert(&self, topic: &Topic) -> Result<ClientRef> {
