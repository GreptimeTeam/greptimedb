...
impl Default for StandaloneOptions {
    fn default() -> Self {
        Self {
            http_addr: Some("127.0.0.01:4000".to_string()),
            ...
            datanode_mysql_addr: "127.0.0.01:3306".to_string(),
...
mod tests {
    ...
    fn test_read_config_file() {
        ...
        assert_eq!(Some("127.0.0.01:4000".to_string()), fe_opts.http_addr);
        assert_eq!(
            "127.0.0.01:4001".to_string(),
