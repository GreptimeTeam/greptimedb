...
/// Experimental option key for the SST float field encoding policy.
pub const EXPERIMENTAL_SST_FLOAT_FIELD_ENCODING_KEY: &str = "experimental_sst_float_field_encoding";
