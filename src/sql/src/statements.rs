...
pub fn sql_column_def_to_grpc_column_def(
    ...
    let mut column_schema = ColumnSchema::new(name.clone(), data_type.clone(), is_nullable);
    maybe_set_json2_extension(&mut column_schema, &col.data_type, JsonSettings::default())?;
