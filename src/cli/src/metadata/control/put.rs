...
mod tests {
    ...
    use super::{
        PutCommand, PutKeyCommand, PutKeyTool, TABLE_ROUTE_PREFIX, unsupported_direct_put_reason,
    ...
    fn test_matches_key_prefix() {
        assert!(super::matches_key_prefix("__table_route", "__table_route"));
        assert!(super::matches_key_prefix(
            "__table_route/1024",
            "__table_route"
        ));
