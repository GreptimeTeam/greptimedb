...
use store_api::region_request::{
    AffectedRows, PathType, RegionCatchupRequest, RegionOpenRequest, ReplayCheckpoint,
};
...
use crate::error::{
    BatchCatchupMitoRegionSnafu, BatchOpenMitoRegionSnafu, NoOpenRegionResultSnafu,
    OpenMitoRegionSnafu, PhysicalRegionNotFoundSnafu, Result,
};
...
impl MetricEngineInner {
    ...
    async fn recover_physical_region_with_results(
        &self,
