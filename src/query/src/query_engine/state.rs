...
use crate::optimizer::scalar_subquery_to_join::ScalarSubqueryToJoin;
...
impl QueryEngineState {
    ...
    pub fn new(
        ...
        // Add rule to convert scalar subquery to join
        let ScalarSubqueryToJoinRule = Arc::new(ScalarSubqueryToJoin::new());
        physical_optimizer
            .rules
            .push(Arc::new(ScalarSubqueryToJoinRule));
