...
use crate::test_util::{
    build_rows_for_key, flush_region, put_rows, rows_schema, CreateRequestBuilder, StorageType,
    TestEnv,
};
...
// TODO: find a way to move this test into the tests-integration
#[tokio::test]
async fn test_engine_drop_region_for_custom_store() {
    ...
    setup(&engine, global_region_id, "File").await;
    ...
    // Before dropping the custom table, both the tables should exist.
    ...
    // drop the created custom region.
    engine
