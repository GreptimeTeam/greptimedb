...
lazy_static! {
    ...
    pub static ref WRITE_BUFFER_BYTES: IntGauge =
        register_int_gauge!("greptimedb_mito_write_buffer_bytes", "mito write buffer bytes").unwrap();
    /// Gauge for open regions
    pub static ref REGION_COUNT: IntGauge =
        register_int_gauge!("greptimedb_mito_region_count", "mito region count").unwrap();
    /// Elapsed time to handle requests.
    pub static ref HANDLE_REQUEST_ELAPSED: HistogramVec = register_histogram_vec!(
            "greptimedb_mito_handle_request_elapsed",
    ...
    pub static ref FLUSH_REQUESTS_TOTAL: IntCounterVec = register_int_counter_vec!(
            "greptimedb_mito_flush_requests_total",
    ...
    pub static ref FLUSH_ERRORS_TOTAL: IntCounter =
        register_int_counter!("greptimedb_mito_flush_errors_total", "mito flush errors total").unwrap();
    /// Elapsed time of a flush job.
    pub static ref FLUSH_ELAPSED: HistogramVec = register_histogram_vec!(
            "greptimedb_mito_flush_elapsed",
            "mito flush elapsed",
            &[TYPE_LABEL]
        )
        .unwrap();
    ...
    pub static ref FLUSH_BYTES_TOTAL: IntCounter =
        register_int_counter!("greptimedb_mito_flush_bytes_total", "mito flush bytes total").unwrap();
    ...
    pub static ref WRITE_STALL_TOTAL: IntCounter =
        register_int_counter!("greptimedb_mito_write_stall_total", "mito write stall total").unwrap();
    /// Counter of rejected write requests.
    pub static ref WRITE_REJECT_TOTAL: IntCounter =
        register_int_counter!("greptimedb_mito_write_reject_total", "mito write reject total").unwrap();
    /// Elapsed time of each write stage.
    pub static ref WRITE_STAGE_ELAPSED: HistogramVec = register_histogram_vec!(
            "greptimedb_mito_write_stage_elapsed",
    ...
    pub static ref WRITE_ROWS_TOTAL: IntCounterVec = register_int_counter_vec!(
        "greptimedb_mito_write_rows_total",
    ...
    pub static ref COMPACTION_STAGE_ELAPSED: HistogramVec = register_histogram_vec!(
        "greptimedb_mito_compaction_stage_elapsed",
    ...
    pub static ref COMPACTION_ELAPSED_TOTAL: Histogram =
        register_histogram!("greptimedb_mito_compaction_total_elapsed", "mito compaction total elapsed").unwrap();
    /// Counter of all requested compaction task.
    pub static ref COMPACTION_REQUEST_COUNT: IntCounter =
        register_int_counter!("greptimedb_mito_compaction_requests_total", "mito compaction requests total").unwrap();
    /// Counter of failed compaction task.
    pub static ref COMPACTION_FAILURE_COUNT: IntCounter =
        register_int_counter!("greptimedb_mito_compaction_failure_total", "mito compaction failure total").unwrap();
    ...
    pub static ref READ_STAGE_ELAPSED: HistogramVec = register_histogram_vec!(
        "greptimedb_mito_read_stage_elapsed",
    ...
    pub static ref READ_ROWS_TOTAL: IntCounterVec =
        register_int_counter_vec!("greptimedb_mito_read_rows_total", "mito read rows total", &[TYPE_LABEL]).unwrap();
    /// Counter of filtered rows during merge.
    pub static ref MERGE_FILTER_ROWS_TOTAL: IntCounterVec =
        register_int_counter_vec!("greptimedb_mito_merge_filter_rows_total", "mito merge filter rows total", &[TYPE_LABEL]).unwrap();
    // ------- End of query metrics.

    // Cache related metrics.
    /// Cache hit counter.
    pub static ref CACHE_HIT: IntCounterVec = register_int_counter_vec!(
        "greptimedb_mito_cache_hit",
        "mito cache hit",
        &[TYPE_LABEL]
    )
    .unwrap();
