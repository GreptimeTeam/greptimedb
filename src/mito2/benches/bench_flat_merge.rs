...
fn bench_merge(c: &mut Criterion) {
    ...
    let shapes = [
        ...
        Shape {
            name: "sparse_1rps_64way_40tags",
            num_iters: 64,
            rows_per_iter: 50_000,
            rows_per_series: 1,
            num_pk_tags: 40,
        },
        Shape {
            name: "sparse_1rps_128way_40tags",
            num_iters: 128,
            rows_per_iter: 25_000,
            rows_per_series: 1,
            num_pk_tags: 40,
        },
        Shape {
            name: "sparse_1rps_256way_40tags",
            num_iters: 256,
            rows_per_iter: 12_500,
            rows_per_series: 1,
            num_pk_tags: 40,
        },
        Shape {
            name: "sparse_1rps_512way_40tags",
            num_iters: 512,
            rows_per_iter: 6_250,
            rows_per_series: 1,
            num_pk_tags: 40,
